...
This project is indexed by GitNexus as **hapi** (10247 symbols, 28081 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/hapi/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/hapi/context` | Codebase overview, check index freshness |
| `gitnexus://repo/hapi/clusters` | All functional areas |
| `gitnexus://repo/hapi/processes` | All execution flows |
| `gitnexus://repo/hapi/process/{name}` | Step-by-step execution trace |
