...
export async function setup() {
    ...
    const hubEnv: NodeJS.ProcessEnv = {
        ...
        HAPI_OIDC_ISSUER: `https://127.0.0.1:${port}`,
        HAPI_AUTH_PEPPER: '0123456789abcdef0123456789abcdef',
        HAPI_BOOTSTRAP_ADMIN_EMAIL: 'admin@test.local',
        HAPI_ORGANIZATION_ID: 'test-org',
        HAPI_ORGANIZATION_NAME: 'Test Org',
        HAPI_OIDC_CLIENT_ID: 'test-client',
        CLI_API_TOKEN: token,
