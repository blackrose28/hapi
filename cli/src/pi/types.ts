...
// Pi model/command summaries — mirrors the shape web/src/types/api.ts and
// hub/src/sync/rpcGateway.ts declare locally (this fork has no shared
// apiTypes.ts module; each package keeps its own copy of these REST-facing
// shapes, matching the existing convention for SlashCommand/OpencodeModelSummary/etc).
