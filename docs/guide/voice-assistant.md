...
The assistant bridges voice communication with your active coding agent (Claude Code, Codex, Cursor Agent, or OpenCode), relaying your requests and summarizing responses in natural speech.
