...
export HAPI_PUBLIC_URL=https://chuonglvubuntu.local
export CORS_ORIGINS=https://chuonglvubuntu.local

export HAPI_ORGANIZATION_ID=local-dev
export HAPI_ORGANIZATION_NAME='HAPI Local'
export HAPI_OIDC_ISSUER=https://chuonglvubuntu.local:8443/realms/hapi-local
...
until curl --fail --silent --show-error \
    https://chuonglvubuntu.local:8443/realms/hapi-local/.well-known/openid-configuration \
    >/dev/null; do
    sleep 1
done
