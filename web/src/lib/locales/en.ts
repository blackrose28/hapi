export default {
  ...
  'orchestrator.list': 'Proxy runs',
  'orchestrator.new': 'New run',
  'orchestrator.empty': 'No orchestrator runs yet.',
  'orchestrator.session': 'Session',
  'orchestrator.initialMessage': 'Initial message',
  'orchestrator.sessionGoal': 'Session goal',
  'orchestrator.systemPrompt': 'System prompt (proxy)',
  'orchestrator.model': 'Model',
  'orchestrator.baseUrl': 'OpenAI base URL (optional)',
  'orchestrator.apiKey': 'OpenAI API key',
  ...
  'orchestrator.openSession': 'Open session',
  'orchestrator.error': 'Error',
  'orchestrator.refresh': 'Refresh',
} as const
