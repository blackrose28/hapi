            ...
            <ThreadPrimitive.Root className="flex min-h-0 flex-1 flex-col relative">
                ...
                >
                    <div ref={viewportRef} className="app-scroll-y min-h-0 flex-1 overflow-x-hidden">
                        <div ref={contentRef} className="mx-auto w-full max-w-full min-w-0 p-2">
                ...
                <ScrollToBottomButton visible={!autoScrollEnabledRef.current && props.pendingCount === 0} onClick={scrollToBottom} />
                {props.outlineOpen ? (
                    <>
                        <button
                            type="button"
