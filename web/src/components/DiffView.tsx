...
function DiffInlineView(props: {
    ...
    return (
        <div className={cn(
            'bg-[var(--app-code-bg)]',
            props.showHeader ? 'rounded-2xl' : 'rounded-none',
            ...
            <div
                className={cn(
                    parentScroll ? 'overflow-visible' : 'overflow-x-auto',
                                ...
                                {lines.map((line, j) => {
                                    ...
                                    return (
                                        <div key={j} className={rowClass} style={rowStyle}>
                                            ...
                                            <div className={cn(parentScroll || isComfortable ? 'whitespace-pre' : 'min-w-0 whitespace-pre-wrap break-words')}>
